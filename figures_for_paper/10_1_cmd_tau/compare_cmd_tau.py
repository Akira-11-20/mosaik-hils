#!/usr/bin/env python3
"""
Compare command delay + linear tau (no compensation) sweep results against RT baseline.

This script:
1. Loads RT baseline and multiple scenarios with linear tau model (no compensation)
...
def main():
    ...
    baseline_dir = base_dir / "20251120-162321_baseline_rt"
    scenario_dirs = [
        {"dir": base_dir / "20251120-162438_delay0ms_nocomp_tau100ms_linear", "cmd_delay": 0.0},
        {"dir": base_dir / "20251120-162355_cmd40ms_sense0ms_nocomp_tau100ms_linear", "cmd_delay": 40.0},
    ]
    ...
    plot_comparison(
        scenarios,
        baseline_data,
        base_dir / "cmd_tau_comparison.png",
        "",
    )
    ...
    with open(summary_file, "w") as f:
        f.write("=" * 80 + "\n")
        f.write("CMD DELAY + LINEAR TAU (NO COMPENSATION) COMPARISON\n")
        f.write("=" * 80 + "\n\n")
        ...
        for scenario in scenarios:
            f.write(f"Command Delay = {scenario['cmd_delay']}ms (Linear τ, No Compensation):\n")
