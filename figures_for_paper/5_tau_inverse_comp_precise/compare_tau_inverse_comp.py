#!/usr/bin/env python3
"""
Compare tau sweep with inverse compensation results against RT baseline.

This script:
1. Loads RT baseline and multiple tau scenarios with inverse compensation
...
def main():
    ...
    baseline_dir = base_dir / "20251119-231539_baseline_rt"
    scenario_dirs = [
        {"dir": base_dir / "20251119-231613_delay0ms_post_comp_tau50ms", "tau": 50.0},
        {"dir": base_dir / "20251119-231649_delay0ms_post_comp_tau100ms", "tau": 100.0},
        {"dir": base_dir / "20251119-231725_delay0ms_post_comp_tau150ms", "tau": 150.0},
        {"dir": base_dir / "20251119-231802_delay0ms_post_comp_tau200ms", "tau": 200.0},
    ]
    ...
    plot_comparison(
        scenarios,
        baseline_data,
        base_dir / "tau_sweep_comparison.png",
        "",
    )
    ...
    with open(summary_file, "w") as f:
        f.write("=" * 80 + "\n")
        f.write("TAU SWEEP COMPARISON: SUMMARY STATISTICS\n")
        f.write("=" * 80 + "\n\n")
        ...
        for scenario in scenarios:
            f.write(f"Plant Tau = {scenario['tau']}ms:\n")
