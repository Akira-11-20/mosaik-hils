#!/usr/bin/env python3
"""
Compare tau sweep results against RT baseline.

This script:
1. Loads RT baseline and multiple tau scenarios
2. Computes error metrics (RMSE, MAE, Max Error)
3. Generates comparison plots split into low/high tau ranges
...
def main():
    ...
    baseline_dir = base_dir / "20251119-225143_baseline_rt"
    scenario_dirs = [
        {"dir": base_dir / "20251119-225216_delay0ms_nocomp_tau50ms", "tau": 50.0},
        {"dir": base_dir / "20251119-225249_delay0ms_nocomp_tau100ms", "tau": 100.0},
        {"dir": base_dir / "20251119-225322_delay0ms_nocomp_tau150ms", "tau": 150.0},
        {"dir": base_dir / "20251119-225355_delay0ms_nocomp_tau200ms", "tau": 200.0},
    ]
