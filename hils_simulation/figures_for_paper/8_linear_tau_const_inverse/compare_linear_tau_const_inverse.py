#!/usr/bin/env python3
"""
Compare linear tau model with constant inverse compensation sweep results against RT baseline.

This script:
1. Loads RT baseline and multiple linear tau + constant inverse compensation scenarios
...
def main():
    ...
    baseline_dir = base_dir / "20251120-150431_baseline_rt"
    scenario_dirs = [
        {"dir": base_dir / "20251120-150502_delay0ms_post_comp_tau50ms_linear", "tau": 50.0},
        {"dir": base_dir / "20251120-150539_delay0ms_post_comp_tau100ms_linear", "tau": 100.0},
        {"dir": base_dir / "20251120-150618_delay0ms_post_comp_tau150ms_linear", "tau": 150.0},
        {"dir": base_dir / "20251120-150656_delay0ms_post_comp_tau200ms_linear", "tau": 200.0},
    ]
        ...
        scenarios.append(
            {
                ...
                "data": data,
                "metrics": metrics,
                "label": f"τ = {tau}ms (Linear + Const Inv)",
            }
        )
    ...
    plot_comparison(
        scenarios,
        baseline_data,
        base_dir / "linear_tau_const_inverse_comparison.png",
        "",
    )
    ...
    with open(summary_file, "w") as f:
        f.write("=" * 80 + "\n")
        f.write("LINEAR TAU + CONSTANT INVERSE COMP SWEEP: SUMMARY STATISTICS\n")
        f.write("=" * 80 + "\n\n")
        ...
        for scenario in scenarios:
            f.write(f"Plant Tau = {scenario['tau']}ms (Linear + Const Inverse):\n")
