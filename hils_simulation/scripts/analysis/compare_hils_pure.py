...
Examples:
  ...
  python compare_mosaik_pure.py --auto
    ...
    parser.add_argument('--mosaik', type=str,
                       help='Path to mosaik HDF5 file')
    parser.add_argument('--pure', type=str,
                       help='Path to Pure Python HDF5 file')
    parser.add_argument('--auto', action='store_true',
                       help='Auto-detect latest mosaik and Pure Python results')
    parser.add_argument('--output', type=str, default='results/mosaik_pure_comparison',
