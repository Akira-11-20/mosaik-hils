...
for k in range(N):
    ...
    if k % 20 == 0:
        print(
            f"Step {k:3d}: Meas={measurement is not None}, Iter={info['num_iterations']}, Buffer={info['buffer_size']}"
        )
...
print("Plot saved to: delay_estimation/mckf_paper_test.png")
...
print("Iteration plot saved to: delay_estimation/mckf_iterations.png")
